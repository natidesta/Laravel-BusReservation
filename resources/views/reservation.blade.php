    ...
    <div class="container">
        <div class="row" >
            <div class="col-md-md-offset-4" style="margin-top:20px;">
                ...
                <hr>
                <form action="{{route('reserve-ticket')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Choose bus id" 
                        name="bus_id" value={{$data[1]}} readonly>
                        <span class="text-danger">@error('bus_id'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="trip_id">Trip id</label>
                        <input type="text" class="form-control" placeholder="Choose trip id" 
                        name="trip_id" value={{$data[2]}} readonly>
                        <span class="text-danger">@error('trip_id'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="ticket_no">ticket Number</label>
                        <input type="text" class="form-control" placeholder="Choose ticket number" 
                        name="ticket_no" value="{{uniqid()}}">
                        <span class="text-danger">@error('ticket_no'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="price">price</label>
                        <input type="text" class="form-control" placeholder="Price" 
                        name="price" value={{$data[0]}} readonly>
                        <span class="text-danger">@error('price'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="no_of_seat">Number of seat</label>
                        <input type="number" class="form-control" placeholder="Choose number of seat" 
                        name="no_of_seat" value="">
                        <span class="text-danger">@error('no_of_seat'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group">
